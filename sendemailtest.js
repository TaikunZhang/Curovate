...
var PA            = require(path.join(__dirname, "/models", "PA.js"));
...
function send_day_1_emails(){
    ...
    console.log("Inside the send eamil function, size of users");
        ...
        if (err){
            ...
            for (i=0; i<user.length; i++){
                ...
                const data = {
                    from: 'Curovate <info@curovate.com>',
                    to: 'taikunzhang581@gmail.com',
                    subject: user.firstname + ", take advantage of Curovate’s ACL recovery tools! Watch video guided exercises, measure your knee extension, and track your progress during your ACL recovery",
                    template: 'day3email',
                    "o:tracking": 'yes',
                    "o:tag" : ['Day3emailA'],
                };
        ...
        if (err){
            ...
            for (i=0; i<user.length; i++){
                ...
                const data = {
                    from: 'Curovate <info@curovate.com>',
                    to: 'taikunzhang581@gmail.com',
                    subject: user.firstname + ", join the Curovate family and complete your 6 month ACL recovery journey!",
                    template: 'day7email',
                    "o:tracking": 'yes',
                    "o:tag" : ['Day7emailA'],
                };
        ...
        if (err){
            ...
            for (i=0; i<user.length; i++){
                ...
                const data = {
                    from: 'Curovate <info@curovate.com>',
                    to: 'taikunzhang581@gmail.com',
                    subject: user.firstname + "! Use these tips and resources to stay engaged with your ACL recovery",
                    template: 'day15email',
                    "o:tracking": 'yes',
                    "o:tag" : ['Day15emailA'],
                };
